 ...
 */
package de.fhdo.ewks.ml_example.xtext.services;
...
public class StructureDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ContextElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fhdo.ewks.ml_example.xtext.StructureDsl.Context");
	...
	public class StructureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fhdo.ewks.ml_example.xtext.StructureDsl.Structure");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fhdo.ewks.ml_example.xtext.StructureDsl.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "de.fhdo.ewks.ml_example.xtext.StructureDsl.Type");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.fhdo.ewks.ml_example.xtext.StructureDsl".equals(grammar.getName())) {
				return grammar;
			}
